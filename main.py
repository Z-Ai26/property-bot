...
def format_property_results(
    ...
    if video_links:
        if len(video_links) == 1:
            lines.append(
                "\n🎥 I also have a stunning, high-quality video "
                "tour of this exact property—would you like me to "
                "send it over so you can experience the full layout "
                "right from your phone?"
            )
        else:
            lines.append(
                "\n🎥 High-quality video tours are also available "
                "for selected properties shown here. Would you like "
                "me to send one over?"
            )
