...
# --- 2. THE ULTIMATE EXPERT AI ROUTING LOGIC (100% BUG-FREE SUPER CODE) ---
    if matches:
        ...
        # 👤 Client Trigger (क्लाइंट के लिए स्मार्ट पेजिनेशन - हर बार अगली 4 यूनिट्स)
        ...
        if is_admin_all:
            ...
            # एकदम सही पेजिनेशन: जैसे ही 'more' कहें, अगली 4 यूनिट्स दिखाएं, खत्म होने पर शुरू से आ जाएं
            start_idx = last_idx
        ...
        # 🚀 सिर्फ visible_matches प्रिंट होंगे, कोई रिपीटीशन नहीं
        ...
        # 👑 THE MASTER PROMPT (क्लाइंट को कभी नहीं बताना कि कुल कितनी यूनिट्स हैं)
        ai_prompt = (
            f"User's message: {user_question}\n\n"
            f"[System Note for AI: The database found matching properties.\n"
            ...
            "2. DO NOT mention total inventory numbers (like 'we have 15 units' or '13 one-bedroom'). Keep it clean and professional.\n"
