...
# ============================================================
def create_smart_apology(user_question: str, past_history: list, filters: dict) -> str:
    ...
    try:
        ...
        return "Sorry, I couldn't find an exact match right now. Please connect with Mr. Zahid at +971562625777."
...
# ============================================================
# Main Reply Creation (The Master Router)
# ============================================================
...
def create_ai_reply(sender: str, user_question: str) -> str:
    ...
    if matches:
        ...
        # 🔥 THE HONEST NOTIFIER (Nearby / Cross-Sell Logic)
    ...
    # Total Miss - Decide between Apology vs General AI
    ...
    # General conversational response (Hi/Hello).
