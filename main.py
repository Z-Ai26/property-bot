...
MAX_PROPERTIES_TO_SHOW = env_int(
    ...
    2,            # 🔥 4 की जगह 2 कर दें (ताकि क्लाइंट को एक बार में 2 दिखें)
    minimum=1,
    maximum=8,    # 🔥 4 की जगह 8 कर दें (ताकि एडमिन लिमिट क्रॉस कर सके)
)
MAX_TOOL_LISTINGS_TO_RETURN = env_int(
    "MAX_TOOL_LISTINGS_TO_RETURN",
    10,           # 🔥 4 की जगह 10 कर दें (ताकि पीछे से 10 प्रॉपर्टी आ सकें)
    minimum=1,
